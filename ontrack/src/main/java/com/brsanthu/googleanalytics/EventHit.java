 ...
 * 
 * <p>
 * For more information, see <a href="https://developers.google.com/analytics/devguides/collection/protocol/v1/parameters#events">GA Parameters Reference</a>
 * </p>
 * 
...
public class EventHit extends GoogleAnalyticsRequest<EventHit> {
	...
	public EventHit(final String eventCategory, final String eventAction) {
		this(eventCategory, eventAction, null, null);
	}

	public EventHit(final String eventCategory, final String eventAction, final String eventLabel, final Integer eventValue) {
		super("event");
	 ...
	 */
	public EventHit eventCategory(final String value) {
	 ...
	 */
	public EventHit eventAction(final String value) {
	 ...
	 */
	public EventHit eventLabel(final String value) {
	 ...
	 */
	public EventHit eventValue(final Integer value) {
