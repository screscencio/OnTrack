...
public class DeclareValueInternalAction implements OneStepInternalAction {

	private ScopeTreeItem selectedTreeItem;
	private final Scope scope;
	private final ProjectContext projectContext;

	public DeclareValueInternalAction(final Scope scope, final ProjectContext projectContext) {
		this.scope = scope;
