...
public class AppActivityManager implements PlaceChangeEvent.Handler, PlaceChangeRequestEvent.Handler {
	...
	private class ProtectedDisplay implements AcceptsOneWidget {
		...
		ProtectedDisplay(final Activity activity) {
	...
	public void onPlaceChange(final PlaceChangeEvent event) {
		final Activity nextActivity = getNextActivity(event);
	...
	public void setDisplay(final AcceptsOneWidget display) {
		...
		final boolean willBeActive = (null != display);
	...
	private void showWidget(final IsWidget view) {
		if (display != null) {
	...
	private Throwable tryStopOrCancel(final boolean stop) {
		Throwable caughtOnStop = null;
		try {
			if (stop) {
