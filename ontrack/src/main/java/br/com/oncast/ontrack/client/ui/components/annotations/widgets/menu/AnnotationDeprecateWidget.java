...
public class AnnotationDeprecateWidget extends Composite implements AnnotationMenuItem {

	private static AnnotationDeprecateWidgetUiBinder uiBinder = GWT.create(AnnotationDeprecateWidgetUiBinder.class);

	interface AnnotationDeprecateWidgetUiBinder extends UiBinder<Widget, AnnotationDeprecateWidget> {}
	...
	public AnnotationDeprecateWidget(final UUID subjectId, final Annotation annotation) {
