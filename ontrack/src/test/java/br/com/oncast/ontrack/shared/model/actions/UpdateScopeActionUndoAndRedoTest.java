...
public class UpdateScopeActionUndoAndRedoTest {
	...
	private void runWith(final String updatePattern) throws UnableToCompleteActionException {
		...
		final ProjectContext context = new ProjectContext(new Project(currentScope, TestReleaseFactory.create("r")));
	...
	private Object getModifiedScope(final String updatePattern)
		...
		executeAction(parent, new ScopeUpdateAction(child.getId(), updatePattern), new ProjectContext(new Project(scope, TestReleaseFactory.create(""))));
