...
//
// private Set<String> clientsToBeReturnedByTheManager;
//
// @Before
// public void setUp() {
...
//
// clientsToBeReturnedByTheManager = new HashSet<String>();
//
// client1 = "1";
// client2 = "2";
//
...
//
// final HashSet<String> expectedClients = new HashSet<String>();
...
// final Session sessionMock = Mockito.mock(Session.class);
// when(sessionManager.getCurrentSession()).thenReturn(sessionMock);
// when(sessionMock.getThreadLocalClientId()).thenReturn(null);
//
